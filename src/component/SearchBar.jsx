  ...
  return (
    <div className="flex items-center gap-3 mt-6 bg-white dark:bg-gray-800 px-4 py-2 rounded-full shadow-md w-full max-w-md">
      ...
      <input
        ...
        className="flex-grow bg-transparent focus:outline-none text-gray-700 dark:text-gray-100"
      />
      <button
        onClick={onSearch}
        className="bg-red-600 hover:bg-red-700 text-white px-4 py-1 rounded-full transition-all"
      >
        Search
      </button>
    </div>
